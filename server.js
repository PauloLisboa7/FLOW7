...
// Serve firebase config from environment (allows Vercel integration)
app.get('/firebase-config.js', (req, res) => {
  const config = {
    apiKey: process.env.FIREBASE_API_KEY || 'AIzaSyDc0FNYmKztYLpvCdt-lMaIGOJyaq1P-Sk',
    authDomain: process.env.FIREBASE_AUTH_DOMAIN || 'flow7-40e0a.firebaseapp.com',
    projectId: process.env.FIREBASE_PROJECT_ID || 'flow7-40e0a',
    storageBucket: process.env.FIREBASE_STORAGE_BUCKET || 'flow7-40e0a.firebasestorage.app',
    messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || '834098968666',
    appId: process.env.FIREBASE_APP_ID || '1:834098968666:web:8c0cc5da802cbf5f680063',
    measurementId: process.env.FIREBASE_MEASUREMENT_ID || 'G-JL413JZF5K'
  };
  res.set('Content-Type', 'application/javascript');
  res.send(`// generated by server
const firebaseConfig = ${JSON.stringify(config)};
// initialize function will run in client scripts (firebase-config.js)
`);
});
